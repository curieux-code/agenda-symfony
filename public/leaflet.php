    ...
    for (var i = 0; i < data.length; i++) {
      if (data[i][0] == "layer1") {
        marker = L.marker([data[i][2], data[i][3]], {
          ...
          icon: greenIcon
        }).bindTooltip(data[i][4]).addTo(layer1).on('click', markerOnClick);
      }
    }
    ...
    for (var i = 0; i < data.length; i++) {
      if (data[i][0] == "layer2") {
        marker = L.marker([data[i][2], data[i][3]], {
          ...
          tags: ['tomato', 'active'],
          icon: greenIcon
        }).bindTooltip(data[i][4]).addTo(layer2).on('click', markerOnClick);
      }
    }
    ...
    for (var i = 0; i < data.length; i++) {
      if (data[i][0] == "layer3") {
        ...
        marker = new PlaceMarker([data[i][2], data[i][3]], {
          ...
          id: data[i][1],
          tags: ['cherry', 'ended']
        }).bindTooltip(data[i][4]).addTo(layer3).on('click', markerOnClick);
      }
    }
...
<body>
  ...
  <!-- Modal EMPTY-->
  <div aria-labelledby="myModalLabel" class="modal right fade" id="emptymodal" role="dialog" tabindex="-1">
