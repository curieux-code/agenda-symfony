 ...
 */
final class Version20190409122009 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE event ADD rubric_id INT NOT NULL');
        $this->addSql('ALTER TABLE event ADD CONSTRAINT FK_3BAE0AA7A29EC0FC FOREIGN KEY (rubric_id) REFERENCES rubric (id)');
        $this->addSql('CREATE INDEX IDX_3BAE0AA7A29EC0FC ON event (rubric_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE event DROP FOREIGN KEY FK_3BAE0AA7A29EC0FC');
        $this->addSql('DROP INDEX IDX_3BAE0AA7A29EC0FC ON event');
        $this->addSql('ALTER TABLE event DROP rubric_id');
    }
}
